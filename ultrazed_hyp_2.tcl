...
#
# ultrazed_hyp_2.tcl: Tcl script for re-creating project 'ultrazed_hyp_2'
#
# Generated by Vivado on Sun Sep 15 18:47:10 CEST 2019
...
#
# 1. This project restoration tcl script (ultrazed_hyp_2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/alex/workspace/vivado1803_workspace/ultrazed_hyp_2/ultrazed_hyp_2.srcs/sources_1/bd/hyp_2/hdl/hyp_2_wrapper.vhd"
#    "/home/alex/workspace/vivado1803_workspace/ultrazed_hyp_2/ultrazed_hyp_2.srcs/constrs_1/imports/new/UltraZed_EG_IO_CC_Master_XDC_File_v1.xdc"
#
...
set _xil_proj_name_ "ultrazed_hyp_2"
...
set script_file "ultrazed_hyp_2.tcl"
...
set_property -name "dsa.board_id" -value "ultrazed_eg_iocc_production" -objects $obj
...
set_property -name "top" -value "hyp_2_wrapper" -objects $obj
...
# Proc to create BD hyp_2
proc cr_bd_hyp_2 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name hyp_2
  ...
  # Create ports
  set PLPMOD7_D0 [ create_bd_port -dir O PLPMOD7_D0 ]
  set PLPMOD7_D1 [ create_bd_port -dir O -from 0 -to 0 PLPMOD7_D1 ]
  set PLPMOD7_D2 [ create_bd_port -dir O PLPMOD7_D2 ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins axi_timer_1/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_ports PLPMOD7_D2] [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins axi_timer_0/capturetrig0] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq1]
  connect_bd_net -net axi_gpio_3_gpio_io_o [get_bd_ports PLPMOD7_D1] [get_bd_pins axi_gpio_3/gpio_io_o] [get_bd_pins axi_timer_0/capturetrig1]
  connect_bd_net -net axi_timer_1_pwm0 [get_bd_ports PLPMOD7_D0] [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins axi_timer_1/pwm0]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_gpio_3/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_timer_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M04_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_3/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_timer_1/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M04_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0002000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timer_0/S_AXI/Reg] SEG_axi_timer_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0004000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_timer_1/S_AXI/Reg] SEG_axi_timer_1_Reg
...
# End of cr_bd_hyp_2()
cr_bd_hyp_2 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files hyp_2.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files hyp_2.bd ] 
set_property IS_ENABLED "1" [get_files hyp_2.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files hyp_2.bd ] 
set_property IS_LOCKED "0" [get_files hyp_2.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files hyp_2.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files hyp_2.bd ] 
set_property PFM_NAME "" [get_files hyp_2.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files hyp_2.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files hyp_2.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files hyp_2.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files hyp_2.bd ] 
set_property USED_IN_SIMULATION "1" [get_files hyp_2.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files hyp_2.bd ] 

# Create 'synth_1' run (if not found)
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu3eg-sfva625-1-i -flow {Vivado Synthesis 2018} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu3eg-sfva625-1-i -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
